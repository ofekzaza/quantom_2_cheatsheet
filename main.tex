...
$\epsilon_{123} = \epsilon_{231} = \epsilon_{312} = 1$, $\epsilon_{321} = -1$.
\textbf{Cross Product:} $(\mathbf{A} \times \mathbf{B})_i = \epsilon_{ijk} A_j B_k$.
\textbf{Contraction Identity:}
\important{\epsilon_{ijk} \epsilon_{ilm} = \delta_{jl}\delta_{km} - \delta_{jm}\delta_{kl}}
