...
\textbf{Definitions:} $\vec{L} = \vec{r} \times \vec{p}$, $\vec{J} = \vec{L} + \vec{S}$.
...
Conjugate: $Y_l^m{}^* = (-1)^m Y_l^{-m}$. Orthogonality: $\int d\Omega Y_{l'}^{m'*} Y_l^m = \delta_{ll'} \delta_{mm'}$.
...
Definition: $[J_z, T_k^q] = \hbar q T_k^q, \quad [J_\pm, T_k^q] = \hbar \sqrt{k(k+1)-q(q\pm 1)} T_k^{q\pm 1}$.
...
\textbf{Heisenberg Eq:} $\frac{d}{dt} O_H = \frac{1}{i\hbar} [O_H, \mathcal{H}] + (\frac{\partial O}{\partial t})_H$.
...
\textbf{Trig:} $\cos a \cos b = \frac{1}{2}[\cos(a-b)+\cos(a+b)]$.
$\sin a \sin b = \frac{1}{2}[\cos(a-b)-\cos(a+b)]$.
$\sin a \cos b = \frac{1}{2}[\sin(a-b)+\sin(a+b)]$.
$\sin(a\pm b) = \sin a\cos b \pm \cos a\sin b$.
$\cos(a\pm b) = \cos a\cos b \mp \sin a\sin b$.
$\cos^2 x = \frac{1+\cos 2x}{2}, \sin^2 x = \frac{1-\cos 2x}{2}$.
\textbf{Series:} $\frac{1}{1-x} = \sum x^n, \quad e^x = \sum \frac{x^n}{n!}$.
$\sin x = \sum \frac{(-1)^n x^{2n+1}}{(2n+1)!}, \quad \cos x = \sum \frac{(-1)^n x^{2n}}{(2n)!}$.
...
\textbf{Quantization:} Poisson $\{f,g\} \to \frac{1}{i\hbar}[F,G]$. Replaces $xp \to \frac{1}{2}(XP+PX)$.
\textbf{Expectation:} $\langle f(X) \rangle = \int_{-\infty}^\infty f(x) |\psi(x)|^2 dx$.
...
$[A,A] = 0, [A, e^{cA}] = 0$. \textbf{Functions:} $[f(A), A] = 0$.
$[A, f(B)] = [A, B]f'(B)$ if $[[A,B],B]=0$.
\textbf{Uncertainty:} $\Delta A \Delta B \ge \frac{1}{2}|\langle [A,B] \rangle|$.
\textbf{BCH:} $e^A e^B = e^{A+B+\frac{1}{2}[A,B] + \dots}$ if $[A,B]$ commutes.
...
Time Translation: $U(t) = e^{-iHt/\hbar}$ (Energy cons).
Space Translation: $T(\vec{a}) = e^{-i\vec{a}\cdot\vec{P}/\hbar}$ (Momentum cons).
Rotation: $R(\hat{n}, \theta) = e^{-i\theta \hat{n}\cdot\vec{J}/\hbar}$ (Ang. Mom cons).
...
$[a, a^\dagger] = 1, \quad \mathcal{H} = \hbar\omega(a^\dagger a + 1/2) = \hbar\omega(N + 1/2)$.
